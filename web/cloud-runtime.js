...
(() => {
  ...
  const mount = () => {
    ...
    root.hidden = true;
    root.innerHTML = `<div class="claw-login-stage"><svg class="claw-login-tubes" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice" aria-hidden="true" focusable="false"><defs><linearGradient id="clawTubeSunrise" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fff8c9"></stop><stop offset=".28" stop-color="#ffe96b"></stop><stop offset=".56" stop-color="#f4d500"></stop><stop offset=".8" stop-color="#d69f00"></stop><stop offset="1" stop-color="#fff0a5"></stop></linearGradient><linearGradient id="clawTubeGold" x1="0" y1="1" x2="1" y2="0"><stop offset="0" stop-color="#d79c00"></stop><stop offset=".3" stop-color="#f6bf00"></stop><stop offset=".58" stop-color="#fff2a6"></stop><stop offset=".82" stop-color="#f4d500"></stop><stop offset="1" stop-color="#bd8400"></stop></linearGradient><linearGradient id="clawTubeLemon" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#fff9d6"></stop><stop offset=".22" stop-color="#f5d600"></stop><stop offset=".56" stop-color="#ffe65a"></stop><stop offset=".78" stop-color="#c98c00"></stop><stop offset="1" stop-color="#fff4b4"></stop></linearGradient><filter id="clawTubeShadow" x="-30%" y="-30%" width="160%" height="160%"><feGaussianBlur in="SourceAlpha" stdDeviation="12" result="blur"></feGaussianBlur><feOffset dy="16" result="offset"></feOffset><feComponentTransfer><feFuncA type="linear" slope=".28"></feFuncA></feComponentTransfer><feMerge><feMergeNode></feMergeNode><feMergeNode in="SourceGraphic"></feMergeNode></feMerge></filter></defs><path d="M-180 790C90 560 250 915 545 690S755 380 980 276c245-113 460 67 740-26 155-52 263-181 360-274" fill="none" stroke="url(#clawTubeSunrise)" stroke-width="112" stroke-linecap="round" stroke-linejoin="round" filter="url(#clawTubeShadow)"></path><path d="M212-116C450 122 678 78 821 332c161 286 514 135 721 2 163-105 316-56 544 154" fill="none" stroke="url(#clawTubeGold)" stroke-width="96" stroke-linecap="round" stroke-linejoin="round" filter="url(#clawTubeShadow)"></path><path d="M388 1120c154-191 383-122 476-336 94-218-119-336 41-548 132-174 384-140 507-318" fill="none" stroke="url(#clawTubeLemon)" stroke-width="82" stroke-linecap="round" stroke-linejoin="round" filter="url(#clawTubeShadow)"></path></svg><form id="clawStagingSignInForm"></form></div>`;
    const form = root.querySelector("form");
    form.className = "claw-login-card claw-login-form";
    form.setAttribute("novalidate", "");
    form.innerHTML = `<div class="claw-login-environment">STAGING</div><div class="claw-login-form-stack"><header class="claw-login-brand"><img src="./assets/brand-logo.png" alt="JOLI POLI" class="claw-login-logo"><div><strong>JOLI POLI</strong><span>Claw Closing</span></div></header><div class="claw-login-heading"><h1>Welcome Back</h1><p>Sign in to continue to Claw Closing</p></div><div id="clawStagingSignInError" class="claw-login-error" role="alert" hidden></div><label class="claw-login-field"><span>Username</span><span class="claw-login-input"><svg aria-hidden="true" viewBox="0 0 24 24"><circle cx="12" cy="8" r="3.25"></circle><path d="M4.75 20c.9-3.25 3.35-5 7.25-5s6.35 1.75 7.25 5"></path></svg><input name="username" type="text" autocomplete="username" required></span></label><label class="claw-login-field"><span>Password</span><span class="claw-login-input"><svg aria-hidden="true" viewBox="0 0 24 24"><rect x="5.5" y="10" width="13" height="10" rx="2"></rect><path d="M8.5 10V7.5a3.5 3.5 0 0 1 7 0V10"></path></svg><input name="password" type="password" autocomplete="current-password" required><button type="button" class="claw-login-password-toggle" aria-label="Show password" title="Show password"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M2.75 12s3.25-5 9.25-5 9.25 5 9.25 5-3.25 5-9.25 5-9.25-5-9.25-5Z"></path><circle cx="12" cy="12" r="2.5"></circle></svg></button></span></label><button type="submit" class="claw-login-submit"><span>Sign In</span></button></div>`;
