...
(() => {
  ...
  const mount = () => {
    ...
    root.hidden = true;
    root.innerHTML = `<div class="claw-login-stage"><div class="claw-login-art claw-login-art-rear" aria-hidden="true"><img class="claw-login-shape claw-login-shape-top-arc" src="./assets/figma-login/asset-13.svg" alt=""><img class="claw-login-shape claw-login-shape-upper-left" src="./assets/figma-login/asset-10.svg" alt=""><img class="claw-login-shape claw-login-shape-mid-left" src="./assets/figma-login/asset-06.svg" alt=""><img class="claw-login-shape claw-login-shape-bottom-left-loop" src="./assets/figma-login/asset-02.svg" alt=""><img class="claw-login-shape claw-login-shape-top-right-loop" src="./assets/figma-login/asset-07.svg" alt=""><img class="claw-login-shape claw-login-shape-bottom-left-crop" src="./assets/figma-login/asset-01.svg" alt=""></div><form id="clawStagingSignInForm"></form><div class="claw-login-art claw-login-art-front" aria-hidden="true"><img class="claw-login-shape claw-login-shape-right-waves" src="./assets/figma-login/asset-11.svg" alt=""><img class="claw-login-shape claw-login-shape-bottom-right-crop" src="./assets/figma-login/asset-14.svg" alt=""></div></div>`;
