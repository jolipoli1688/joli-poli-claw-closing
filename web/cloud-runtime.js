...
(() => {
  ...
  const mount = () => {
    ...
    root.hidden = true;
    root.innerHTML = `<div class="claw-login-stage"><svg class="claw-login-tubes" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice" aria-hidden="true" focusable="false"><defs><linearGradient id="clawTubeSunrise" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fff8c9"></stop><stop offset=".28" stop-color="#ffe96b"></stop><stop offset=".56" stop-color="#f4d500"></stop><stop offset=".8" stop-color="#d69f00"></stop><stop offset="1" stop-color="#fff0a5"></stop></linearGradient><linearGradient id="clawTubeGold" x1="0" y1="1" x2="1" y2="0"><stop offset="0" stop-color="#d79c00"></stop><stop offset=".3" stop-color="#f6bf00"></stop><stop offset=".58" stop-color="#fff2a6"></stop><stop offset=".82" stop-color="#f4d500"></stop><stop offset="1" stop-color="#bd8400"></stop></linearGradient><filter id="clawTubeShadow" x="-30%" y="-30%" width="160%" height="160%"><feGaussianBlur in="SourceAlpha" stdDeviation="7" result="blur"></feGaussianBlur><feOffset dy="10" result="offset"></feOffset><feComponentTransfer><feFuncA type="linear" slope=".18"></feFuncA></feComponentTransfer><feMerge><feMergeNode></feMergeNode><feMergeNode in="SourceGraphic"></feMergeNode></feMerge></filter></defs><path d="M-170 910C85 640 295 964 565 748c156-125 191-267 350-317" fill="none" stroke="url(#clawTubeSunrise)" stroke-width="104" stroke-linecap="round" stroke-linejoin="round" filter="url(#clawTubeShadow)"></path><path d="M1740-110c-89 102-164 229-307 289-141 60-251 19-350 120" fill="none" stroke="url(#clawTubeGold)" stroke-width="90" stroke-linecap="round" stroke-linejoin="round" filter="url(#clawTubeShadow)"></path></svg><form id="clawStagingSignInForm"></form></div>`;
