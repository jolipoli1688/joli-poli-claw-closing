...
assert.match(edge, /existing_closing_id/, "Start Shift must reuse an existing same-day draft");
assert.match(edge, /reportDate > today/, "Start Shift must reject future dates");
...
assert.match(app, /existing_closing_id/, "client must reopen the server-selected same-day draft");
